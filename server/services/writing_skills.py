...
TASK_SKILLS = {
    "segment": WritingSkill(
        "task.segment",
        "1.0.0",
        "task",
        30,
        "只写当前分段契约分配的场景或动作，不把整章结构压进本段。承接给定正文的实际人物位置、"
        "伤势、物品归属、已知信息和已付出的代价；已经发生的救援、身份揭示或物品毁坏不能再次上演。"
        "本段用具体行动和阻力改变局面，未分配的后续节点仅用于控制铺垫，不提前兑现。"
        "只有终段负责章尾收束；中间段保持因果衔接，不强制每段重开悬念或重复五拍结构。",
    ),
